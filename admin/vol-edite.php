                ...
                <div class="card-body">
                    ...
                    ?>
                            <form action="codes/vol-code.php" method="POST">
                                <input type="hidden" name="vol_id" value="<?= $result['id_vol'] ?>">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="aller" value="<?= $result['aller'] ?>" required class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label for="">Date de retour</label>
                                    <input type="datetime-local" name="retour" value="<?= $result['retour'] ?>" required class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label for="">Compagnie</label>
                                    <input type="text" name="compagnie" value="<?= $result['compagnie'] ?>" required class="form-control">
                                </div>
                                <div class="mb-3">
