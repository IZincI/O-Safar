...
class AuthenticationController
{
    ...
    public function admin()
    {
        ...
        $checkAdmin = "SELECT id_client,role_as FROM user WHERE id_client='$user_id' AND role_as='1' LIMIT 1";
    ...
    public function authDetail()
    {
        ...
        if ($checkAuth) {
            ...
            $getUserData = "SELECT * FROM user WHERE id_client='$user_id' LIMIT 1";
