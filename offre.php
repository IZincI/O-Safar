    ...
    <div id="content-wrapper">
        ...
        <div class="column">
            ...
            <div id="slide-wrapper">
                <img id="slideLeft" class="arrow" onclick="ChangeSlide(1)" src="public/imgs/offre/suite.jpeg">

                <iconify-icon icon="material-symbols:arrow-circle-left-rounded" width="20"></iconify-icon>
                ...
                <img id="slideRight" class="arrow" onclick="ChangeSlide(1)" src="public/imgs/offre/maroco.jpeg">
            </div>
        </div>
        <div class="column">
